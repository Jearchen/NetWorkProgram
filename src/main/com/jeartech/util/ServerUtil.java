...
public class ServerUtil {
    ...
    public  NioSocketAcceptor createInstance(int localPort) throws IOException {
        GateWayServer gateWayServer = new GateWayServer();
        server.setHandler(gateWayServer);
    ...
    private  class GateWayServer extends IoHandlerAdapter {
...
//            System.out.println("接受报文"+byte2Hex(newBytes));
        ...
        public void messageSent(IoSession session, Object message) throws Exception {
            ...
            byte[] newBytes = new byte[newBytesLen];
            buffer.get(newBytes, buffer.position(), newBytesLen);
            System.out.println("发送报文："+byte2Hex(newBytes));
        }
